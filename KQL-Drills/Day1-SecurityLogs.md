...
![Drill 1 - Failed logins by username](KQL-Drills/88.150.11.111.png)
...
| order by FailedAttempts desc
![Drill 2 - Failed logins by IP](KQL-Drills/src ip.png)
```
...
![Drill 3 - Phishing detection](KQL-Drills/3800 query.png)
